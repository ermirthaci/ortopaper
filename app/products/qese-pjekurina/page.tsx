...
const sizeGroups = [
  {
    ...
    sizes: ["10cm x 10cm", "11cm x 11cm", "11cm x 13cm"],
  },
  {
    headerKey: "product.thase-letre.size.group1",
    sizes: ["8cm x 12cm", "8cm x 22cm", "8cm x 33cm", "8cm x 43cm", "8cm x 53cm"],
  },
  {
    headerKey: "product.thase-letre.size.group1",
    sizes: ["10cm x 12cm", "10cm x 22cm", "10cm x 33cm", "10cm x 43cm", "10cm x 53cm"],
  },
  {
    headerKey: "product.thase-letre.size.group1",
    sizes: ["15cm x 12cm", "15cm x 33cm", "15cm x 43cm", "15cm x 53cm"],
  },
  {
    headerKey: "product.thase-letre.size.group1",
    sizes: ["13cm x 12cm", "13cm x 22cm", "13cm x 33cm", "13cm x 43cm", "13cm x 53cm"],
  },
  {
    headerKey: "product.thase-letre.size.group1",
    sizes: ["17cm x 22cm", "17cm x 24cm", "17cm x 33cm", "17cm x 43cm", "17cm x 53cm"],
  },
  {
    headerKey: "product.thase-letre.size.group1",
    sizes: ["20cm x 15cm", "20cm x 25cm", "20cm x 32cm", "20cm x 43cm", "20cm x 52cm"],
  },
  {
    headerKey: "product.thase-letre.size.group1",
    sizes: ["25cm x 25cm", "25cm x 32cm", "25cm x 43cm", "25cm x 52cm"],
  },
]
export default function QesePjekurinaPage() {
  const { t } = useLanguage()
        ...
        <div className="px-6 md:px-8 lg:px-16">
          <div className="relative aspect-[16/9] rounded-tl-[80px] rounded-br-[80px] md:rounded-tl-[160px] md:rounded-br-[160px] lg:rounded-tl-[266px] lg:rounded-br-[266px] overflow-hidden border-[2px] md:border-[3px] border-[#747474] flex items-center justify-center group">
            ...
            <div className="relative z-10 flex items-center justify-center w-full h-full">
              <Image
                src="/images/pjekurina.png"
                alt="QESE PËR PJEKURINA"
                width={600}
                height={700}
        ...
        <div className="px-6 md:px-8 lg:px-16 grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-light text-white mb-4 md:mb-6">
              {t("product.qese-pjekurina.description.title")}
            </h2>
            <p className="text-gray-300 text-sm md:text-base leading-relaxed mb-4">{t("product.qese-pjekurina.description.para1")}</p>
            <p className="text-gray-300 text-sm md:text-base leading-relaxed">{t("product.qese-pjekurina.description.para2")}</p>
          </div>
              ...
              <div>
               ...
               <div className="space-y-4 md:space-y-6">
                  {sizeGroups.map((group, groupIndex) => (
                    <div key={groupIndex}>
                      <div className="border-b border-[#707070]/35 mb-2 md:mb-3 pb-2"></div>
