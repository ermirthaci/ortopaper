...
const sizeGroups = [
  {
    headerKey: "product.qese-letre.size.group1",
    sizes: ["41cm x 18cm x 12cm", "41cm x 20cm x 10cm", "40cm x 18cm x 12cm", "40cm x 40cm x 21cm", "40cm x 41cm x 13cm", "40cm x 30cm x 12cm", "37cm x 30cm x 21cm", "36cm x 25cm x 11cm", "34cm x 32cm x 18cm", "34cm x 31cm x 16cm", "34cm x 26cm x 18cm", "33cm x 32cm x 16cm", "32cm x 23cm x 10cm", "30cm x 21cm x 12cm", "28cm x 26cm x 16cm", "22cm x 23cm x 12cm"],
  },
  {
    headerKey: "product.qese-letre.size.group2",
    sizes: ["50cm x 40cm x 21cm", "42cm x 32cm x 16cm", "42cm x 16cm x 10cm", "41cm x 25cm x 11cm", "37cm x 18cm x 8cm", "33cm x 31cm x 15cm", "32cm x 34cm x 16cm", "32cm x 14cm x 7cm", "31cm x 21cm x 12cm", "30cm x 22cm x 12cm", "30cm x 18cm x 12cm", "28cm x 27cm x 16cm", "28cm x 10cm x 7cm", "25cm x 13cm x 7cm", "25cm x 9cm x 6cm", "23cm x 9cm x 6cm", "22cm x 13cm x 8cm", "22cm x 13cm x 7cm"],
  },
]
export default function QeseletrePage() {
  const { t } = useLanguage()
        ...
        <div className="px-6 md:px-8 lg:px-16 grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-light text-white mb-4 md:mb-6">
              {t("product.qese-letre.description.title")}
            </h2>
            <p className="text-gray-300 text-sm md:text-base leading-relaxed mb-4">{t("product.qese-letre.description.para1")}</p>
            <p className="text-gray-300 text-sm md:text-base leading-relaxed">{t("product.qese-letre.description.para2")}</p>
          </div>
